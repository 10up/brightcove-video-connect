...
var VideoEditView = BrightcoveView.extend(
	{
		...
		/**
		 * Provides an array of language codes for use with captions. Sets this
		 * list to the wpbc.preload object, as wpbc.preload.languages
		 */
		languages: function() {
			var languages = {
				'languages': [
					{ 'nicename': 'English',          'code': 'en' },
					{ 'nicename': 'Abkhaz',           'code': 'ab' },
					{ 'nicename': 'Afar',             'code': 'aa' },
					{ 'nicename': 'Afrikaans',        'code': 'af' },
					{ 'nicename': 'Akan',             'code': 'ak' },
					{ 'nicename': 'Albanian',         'code': 'sq' },
					{ 'nicename': 'Amharic',          'code': 'am' },
					{ 'nicename': 'Arabic',           'code': 'ar' },
					{ 'nicename': 'Aragonese',        'code': 'an' },
					{ 'nicename': 'Armenian',         'code': 'hy' },
					{ 'nicename': 'Assamese',         'code': 'as' },
					{ 'nicename': 'Avaric',           'code': 'av' },
					{ 'nicename': 'Avestan',          'code': 'ae' },
					{ 'nicename': 'Aymara',           'code': 'ay' },
					{ 'nicename': 'Azerbaijani',      'code': 'az' },
					{ 'nicename': 'Bambara',          'code': 'bm' },
					{ 'nicename': 'Bashkir',          'code': 'ba' },
					{ 'nicename': 'Basque',           'code': 'eu' },
					{ 'nicename': 'Belarusian',       'code': 'be' },
					{ 'nicename': 'Bengali',          'code': 'bn' },
					{ 'nicename': 'Bihari',           'code': 'bh' },
					{ 'nicename': 'Bislama',          'code': 'bi' },
					{ 'nicename': 'Bosnian',          'code': 'bs' },
					{ 'nicename': 'Breton',           'code': 'br' },
					{ 'nicename': 'Bulgarian',        'code': 'bg' },
					{ 'nicename': 'Burmese',          'code': 'my' },
					{ 'nicename': 'Catalan',          'code': 'ca' },
					{ 'nicename': 'Chomorro',         'code': 'ch' },
					{ 'nicename': 'Chechen',          'code': 'ce' },
					{ 'nicename': 'Chichewa',         'code': 'ny' },
					{ 'nicename': 'Chinese',          'code': 'zh' },
					{ 'nicename': 'Chuvash',          'code': 'cv' },
					{ 'nicename': 'Cornish',          'code': 'kw' },
					{ 'nicename': 'Corsican',         'code': 'co' },
					{ 'nicename': 'Cree',             'code': 'cr' },
					{ 'nicename': 'Croatian',         'code': 'hr' },
					{ 'nicename': 'Czech',            'code': 'cs' },
					{ 'nicename': 'Danish',           'code': 'da' },
					{ 'nicename': 'Divehi',           'code': 'dv' },
					{ 'nicename': 'Dutch',            'code': 'nl' },
					{ 'nicename': 'Dzongkha',         'code': 'dz' },
					{ 'nicename': 'Esperanto',        'code': 'eo' },
					{ 'nicename': 'Estonian',         'code': 'et' },
					{ 'nicename': 'Ewe',              'code': 'ee' },
					{ 'nicename': 'Faroese',          'code': 'fo' },
					{ 'nicename': 'Fijian',           'code': 'fj' },
					{ 'nicename': 'Finnish',          'code': 'fi' },
					{ 'nicename': 'French',           'code': 'fr' },
					{ 'nicename': 'Fula',             'code': 'ff' },
					{ 'nicename': 'Galician',         'code': 'gl' },
					{ 'nicename': 'Georgian',         'code': 'ka' },
					{ 'nicename': 'German',           'code': 'de' },
					{ 'nicename': 'Greek',            'code': 'el' },
					{ 'nicename': 'Guarani',          'code': 'gn' },
					{ 'nicename': 'Gujarati',         'code': 'gu' },
					{ 'nicename': 'Haitian',          'code': 'ht' },
					{ 'nicename': 'Hausa',            'code': 'ha' },
					{ 'nicename': 'Hebrew',           'code': 'he' },
					{ 'nicename': 'Herero',           'code': 'hz' },
					{ 'nicename': 'Hindi',            'code': 'hi' },
					{ 'nicename': 'Hiri Motu',        'code': 'ho' },
					{ 'nicename': 'Hungarian',        'code': 'hu' },
					{ 'nicename': 'Interlingua',      'code': 'ia' },
					{ 'nicename': 'Indonesian',       'code': 'id' },
					{ 'nicename': 'Irish',            'code': 'ga' },
					{ 'nicename': 'Igbo',             'code': 'ig' },
					{ 'nicename': 'Inupiaq',          'code': 'ik' },
					{ 'nicename': 'Icelandic',        'code': 'is' },
					{ 'nicename': 'Italian',          'code': 'it' },
					{ 'nicename': 'Inuktitut',        'code': 'iu' },
					{ 'nicename': 'Japanese',         'code': 'ja' },
					{ 'nicename': 'Javanese',         'code': 'jv' },
					{ 'nicename': 'Kalaallisut',      'code': 'kl' },
					{ 'nicename': 'Kannada',          'code': 'kn' },
					{ 'nicename': 'Kanuri',           'code': 'kr' },
					{ 'nicename': 'Kashmiri',         'code': 'ks' },
					{ 'nicename': 'Kazakh',           'code': 'kk' },
					{ 'nicename': 'Khmer',            'code': 'km' },
					{ 'nicename': 'Kikuyu',           'code': 'ki' },
					{ 'nicename': 'Kinyarwanda',      'code': 'rw' },
					{ 'nicename': 'Kyrgyz',           'code': 'ky' },
					{ 'nicename': 'Komi',             'code': 'kv' },
					{ 'nicename': 'Kongo',            'code': 'kg' },
					{ 'nicename': 'Korean',           'code': 'ko' },
					{ 'nicename': 'Kurdish',          'code': 'ku' },
					{ 'nicename': 'Kwanyama',         'code': 'kj' },
					{ 'nicename': 'Latin',            'code': 'la' },
					{ 'nicename': 'Luxembourgish',    'code': 'lb' },
					{ 'nicename': 'Ganda',            'code': 'lg' },
					{ 'nicename': 'Limburgish',       'code': 'li' },
					{ 'nicename': 'Lingala',          'code': 'ln' },
					{ 'nicename': 'Lao',              'code': 'lo' },
					{ 'nicename': 'Lithuanian',       'code': 'lt' },
					{ 'nicename': 'Luba-Katanga',     'code': 'lu' },
					{ 'nicename': 'Latvian',          'code': 'lv' },
					{ 'nicename': 'Manx',             'code': 'gv' },
					{ 'nicename': 'Macedonian',       'code': 'mk' },
					{ 'nicename': 'Malagasy',         'code': 'mg' },
					{ 'nicename': 'Malay',            'code': 'ms' },
					{ 'nicename': 'Malayalam',        'code': 'ml' },
					{ 'nicename': 'Maltese',          'code': 'mt' },
					{ 'nicename': 'Maori',            'code': 'mi' },
					{ 'nicename': 'Marathi',          'code': 'mr' },
					{ 'nicename': 'Marshallese',      'code': 'mh' },
					{ 'nicename': 'Mongolian',        'code': 'mn' },
					{ 'nicename': 'Nauruan',          'code': 'na' },
					{ 'nicename': 'Navajo',           'code': 'nv' },
					{ 'nicename': 'Northern Ndebele', 'code': 'nd' },
					{ 'nicename': 'Nepali',           'code': 'ne' },
					{ 'nicename': 'Ndonga',           'code': 'ng' },
					{ 'nicename': 'Norwegian Bokmal', 'code': 'nb' },
					{ 'nicename': 'Norwegian Nyorsk', 'code': 'nn' },
					{ 'nicename': 'Norwegian',        'code': 'no' },
					{ 'nicename': 'Nuosu',            'code': 'ii' },
					{ 'nicename': 'Southern Ndebele', 'code': 'nr' },
					{ 'nicename': 'Occitan',          'code': 'oc' },
					{ 'nicename': 'Ojibwe',           'code': 'oj' },
					{ 'nicename': 'Oromo',            'code': 'om' },
					{ 'nicename': 'Oriya',            'code': 'or' },
					{ 'nicename': 'Ossetian',         'code': 'os' },
					{ 'nicename': 'Panjabi',          'code': 'pa' },
					{ 'nicename': 'Pali',             'code': 'pi' },
					{ 'nicename': 'Persian',          'code': 'fa' },
					{ 'nicename': 'Polish',           'code': 'pl' },
					{ 'nicename': 'Pashto',           'code': 'ps' },
					{ 'nicename': 'Portuguese',       'code': 'pt' },
					{ 'nicename': 'Quechua',          'code': 'qu' },
					{ 'nicename': 'Romanish',         'code': 'rm' },
					{ 'nicename': 'Russian',          'code': 'ru' },
					{ 'nicename': 'Sanskrit',         'code': 'sa' },
					{ 'nicename': 'Sardinian',        'code': 'sc' },
					{ 'nicename': 'Sindhi',           'code': 'sd' },
					{ 'nicename': 'Northern Sami',    'code': 'se' },
					{ 'nicename': 'Samoan',           'code': 'sm' },
					{ 'nicename': 'Sango',            'code': 'sg' },
					{ 'nicename': 'Serbian',          'code': 'sr' },
					{ 'nicename': 'Scottish Gaelic',  'code': 'gd' },
					{ 'nicename': 'Shona',            'code': 'sn' },
					{ 'nicename': 'Sinhala',          'code': 'si' },
					{ 'nicename': 'Slovak',           'code': 'sk' },
					{ 'nicename': 'Slovene',          'code': 'sl' },
					{ 'nicename': 'Somali',           'code': 'so' },
					{ 'nicename': 'Southern Sotho',   'code': 'st' },
					{ 'nicename': 'Spanish',          'code': 'es' },
					{ 'nicename': 'Sudanese',         'code': 'su' },
					{ 'nicename': 'Swahili',          'code': 'sw' },
					{ 'nicename': 'Swati',            'code': 'ss' },
					{ 'nicename': 'Swedish',          'code': 'sv' },
					{ 'nicename': 'Tamil',            'code': 'ta' },
					{ 'nicename': 'Telugu',           'code': 'te' },
					{ 'nicename': 'Tajik',            'code': 'tg' },
					{ 'nicename': 'Thai',             'code': 'th' },
					{ 'nicename': 'Tigrinya',         'code': 'ti' },
					{ 'nicename': 'Tibetan',          'code': 'bo' },
					{ 'nicename': 'Turkmen',          'code': 'tk' },
					{ 'nicename': 'Tagalog',          'code': 'tl' },
					{ 'nicename': 'Tswana',           'code': 'tn' },
					{ 'nicename': 'Tonga',            'code': 'to' },
					{ 'nicename': 'Turkish',          'code': 'tr' },
					{ 'nicename': 'Tsonga',           'code': 'ts' },
					{ 'nicename': 'Tatar',            'code': 'tt' },
					{ 'nicename': 'Twi',              'code': 'tw' },
					{ 'nicename': 'Tahitian',         'code': 'ty' },
					{ 'nicename': 'Uyghur',           'code': 'ug' },
					{ 'nicename': 'Ukrainian',        'code': 'uk' },
					{ 'nicename': 'Urdu',             'code': 'ur' },
					{ 'nicename': 'Uzbek',            'code': 'uz' },
					{ 'nicename': 'Venda',            'code': 've' },
					{ 'nicename': 'Vietnamese',       'code': 'vi' },
					{ 'nicename': 'Volapuk',          'code': 'vo' },
					{ 'nicename': 'Walloon',          'code': 'wa' },
					{ 'nicename': 'Welsh',            'code': 'cy' },
					{ 'nicename': 'Wolof',            'code': 'wo' },
					{ 'nicename': 'Western Frisian',  'code': 'fy' },
					{ 'nicename': 'Xhosa',            'code': 'xh' },
					{ 'nicename': 'Yiddish',          'code': 'yi' },
					{ 'nicename': 'Yoruba',           'code': 'yo' },
					{ 'nicename': 'Zhuang',           'code': 'za' },
					{ 'nicename': 'Zulu',             'code': 'zu' },
				]
			}

			// Set our object to the wpbc.preload
			wpbc.preload.languages = languages;
		},
