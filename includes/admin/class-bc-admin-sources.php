...
class BC_Admin_Sources {
	...
	/**
	 * Stores admin_notices messages
	 *
	 * @var array $notices notices array
	 */
	public $notices;
	...
	public function render_add_html() {
		...
		<div class="wrap">
			<h2>
			<?php
				printf( '<img src="%s" class="bc-page-icon"/>', esc_url( plugins_url( 'images/menu-icon.svg', dirname( __DIR__ ) ) ) );
			?>
	...
	/**
	 * Renders edit source html
	 *
	 * @param array $account Brightcove account data
	 */
		...
		<div class="wrap">
			...
			<form action="" method="post">
				...
				<p class="submit">
					...
					<input type="submit" name="brightcove-edit-account-submit" id="brightcove-edit-account-submit" class="button button-primary"
						value="<?php esc_html_e( 'Save Changes', 'brightcove' ); ?>">
				</p>
			</form>
		</div>
		<?php
