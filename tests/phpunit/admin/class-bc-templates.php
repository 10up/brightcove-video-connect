...
class BC_Admin_Templates {
	...
	public function add_templates() {
				...
				<div class="js--select-attachment type- subtype- ">
					<div class="thumbnail">
						<# if ( data.images && data.images.thumbnail && data.images.thumbnail.src ) { #>
							...
							<# } else { #>
								<img src="<?php echo BRIGHTCOVE_URL . 'images/admin/video-processing-large.png'; ?>"
								     width="162" height="94">
								<# } #>
									<div class="duration">
					...
					<div class="bc-info">
						...
						<span class="bc-updated">{{data.updated_at_readable}}</span>
							<span class="row-actions">
								<span class="video-move-up"><a
										href="#">&uarr; <?php esc_html_e( 'Move up', 'brightcove' ) ?></a></span> |
								<span class="video-move-down"><a
										href="#">&darr; <?php esc_html_e( 'Move Down', 'brightcove' ) ?></a></span> |
			...
			<li class="attachment brightcove">
				<div class=" js--select-attachment type- subtype- ">
					...
					<div class="bc-info">
						<span class="bc-name">{{data.name}}</span>
						<span class="bc-updated">{{data.updated_at_readable}}</span>
						<span class="row-actions"><span class="add-to-playlist"><a href="#"
						                                                           class="button action"><?php esc_html_e( 'Add to playlist', 'brightcove' ) ?></a></span></span>
					</div>
				</div>
			</li>
		</script>
		...
		<script type="text/html" id="tmpl-brightcove-playlist-edit">
			<div class="settings">
				<label class="playlist-name">
					...
					<a href="#"
					   class="button button-primary button-large media-button brightcove back"><?php esc_html_e( 'Back', 'brightcove' ); ?></a>
		...
		<script type="text/html" id="tmpl-brightcove-video-edit">
			...
			<div class="brightcove brightcove-buttons">
				...
				<span class="more-actions">
					...
					<a href="#"
					   class="button button-secondary button-large media-button brightcove back"><?php esc_html_e( 'Back', 'brightcove' ); ?></a>
					<a href="#"
					   class="button button-primary button-large media-button brightcove save-sync"><?php esc_html_e( 'Save and Sync Changes', 'brightcove' ); ?></a>
				</span>
			</div>
		</script>
		...
		<script type="text/html" id="tmpl-brightcove-video-preview">
			...
			<iframe src="//players.brightcove.net/{{data.account_id}}/default_default/index.html?videoId={{data.id}}"
		...
		<script type="text/html" id="tmpl-brightcove-media-modal">
			<div class="media-modal wp-core-ui">
				<a class="media-modal-close brightcove" href="#"><span class="media-modal-icon"><span
				...
				<div class="media-modal-content">
					<div class="media-frame mode-select wp-core-ui" id="__wp-uploader-id-0">
						<div class="media-frame-title">
							<h1>
								<img class="bc-page-icon"
								     src="<?php echo esc_url( BRIGHTCOVE_URL . 'images/admin/menu-icon.svg' ); ?>"> <?php esc_html_e( 'Brightcove', 'brightcove' ); ?>
							</h1>
						</div>
						<div class="media-frame-router">
							<div class="media-router">
								<a href="#"
								   class="brightcove upload media-menu-item"><?php esc_html_e( 'Upload Files', 'brightcove' ) ?></a><a
									href="#"
									class="brightcove videos media-menu-item active"><?php esc_html_e( 'Videos', 'brightcove' ) ?></a><a
									href="#"
									class="brightcove playlists media-menu-item"><?php esc_html_e( 'Playlists', 'brightcove' ) ?></a>
							</div>
						</div>
						...
						<div class="media-frame-toolbar">
							<div class="media-toolbar">
								<div class="media-toolbar-secondary">
									<div class="media-selection empty">
										<div class="selection-info">
											<span class="count">0 selected</span> <a class="edit-selection"
											                                         href="#"><?php esc_html_e( 'Edit Selection', 'brightcove' ); ?></a>
											<a class="clear-selection"
											   href="#"><?php esc_html_e( 'Clear', 'brightcove' ); ?></a>
										</div>
								...
								<div class="media-toolbar-primary search-form">
									<a href="#"
									   class="button media-button button-primary button-large media-button-insert brightcove"
									   disabled="disabled"><?php esc_html_e( 'Insert Into Post', 'brightcove' ); ?></a>
								</div>
							</div>
						</div>
						...
						<div id="html5_19jecn1m2eteuqiud64df15595_container" class="moxie-shim moxie-shim-html5"
						     style="position: absolute; top: 0px; left: 0px; width: 0px; height: 0px; overflow: hidden; z-index: 0;">
							<input id="html5_19jecn1m2eteuqiud64df15595" type="file"
		...
		<script type="text/html" id="tmpl-brightcove-uploader-queued-files">
			<div class="brightcove-upload-queued-files">
				<div class="pending-uploads">
					...
					<br>
					<button
						class="brightcove-start-upload button action"><?php esc_html_e( 'Start Upload', 'brightcove' ); ?></button>
				</div>
			</div>
			...
			<div class="uploader-inline-content">
				...
				<?php else : ?>
					<div class="upload-ui">
						...
						<a href="#" id="brightcove-select-files-button"
						   class="browser button button-hero"><?php esc_html_e( 'Select Files', 'brightcove' ); ?></a>
					</div>
		...
		<script type="text/html" id="tmpl-brightcove-media-item-grid">
			<div
				...
				<div class="thumbnail">
					<# if ( data.images && data.images.thumbnail && data.images.thumbnail.src ) { #>
						<img src="{{ data.images.thumbnail.src }}" class="icon" draggable="false" width="162"
						     height="94"/>
						<# } else { #>
							<# if ( data.video_ids ) { #>
								<img src="<?php echo BRIGHTCOVE_URL . 'images/admin/video-playlist-large.png'; ?>"
																...
																<# if ( 1 === data.video_ids.length ) { #>
																	...
																	<# } else { #>
																		...
																		<# } #>
																			<# } else { #>
																				<span
																					class="brightcove-smart-playlist"><?php esc_html_e( 'Smart', 'brightcove' ); ?></span>
																				<# } #>
														</div>
														<# } #>
				</div>
				...
				<div class="media-actions">
					<a href="#"
					   class="button media-button brightcove edit"><?php esc_html_e( 'Edit', 'brightcove' ); ?></a>
					<a href="#"
					   class="button media-button brightcove preview"><?php esc_html_e( 'Preview', 'brightcove' ); ?></a>
				</div>
			</div>
		</script>
		...
		<script type="text/html" id="tmpl-brightcove-media-item-details-videos">
			<div
				class="attachment-detail js--select-attachment type-list subtype-{{ data.subtype }} {{ data.orientation }}">
				<div class="thumbnail">
					<# if ( data.images && data.images.poster && data.images.poster.src ) { #>
						<img src="{{ data.images.poster.src }}" class="detail-icon" draggable="false" width="300"
						     height="172"/>
						<# } else { #>
							<img src="<?php echo BRIGHTCOVE_URL . 'images/admin/video-processing-large.png'; ?>"
				...
				<div class="video-info">
					...
					<div class="video-source"><span
							class="title"><?php esc_html_e( 'Source: ', 'brightcove' ); ?></span><span class="data">{{ data.account_name }}</span>
					</div>
					<div class="video-id"><span
							class="title"><?php esc_html_e( 'Video ID: ', 'brightcove' ); ?></span><span class="data">{{ data.id }}</span>
					</div>
				</div>
				<div class="media-actions">
					<# if ('preview' === data.detailsMode) { #>
						<a href="#"
						   class="button media-button brightcove back"><?php esc_html_e( 'Back', 'brightcove' ); ?></a>
						<# } else { #>
							<a href="#"
							   class="button media-button brightcove edit"><?php esc_html_e( 'Edit', 'brightcove' ); ?></a>
							<a href="#"
		...
		<script type="text/html" id="tmpl-brightcove-media-item-details-playlists">
			<div
				...
				<div class="playlist-info">
					...
					<div class="playlist-id"><span
							class="title"><?php esc_html_e( 'Playlist ID: ', 'brightcove' ); ?></span><span
							class="data">{{ data.id }}</span></div>
					<div class="account-name"><span
							class="title"><?php esc_html_e( 'Account Name: ', 'brightcove' ); ?></span><span
							class="data">{{ data.account_name }}</span></div>
					<div class="created-date"><span
							class="title"><?php esc_html_e( 'Created At: ', 'brightcove' ); ?></span><span class="data">{{ data.created_at_readable }}</span>
					</div>
					<div class="updated-date"><span
							class="title"><?php esc_html_e( 'Updated At: ', 'brightcove' ); ?></span><span class="data">{{ data.updated_at_readable }}</span>
					</div>
					<div class="playlist-type"><span
							class="title"><?php esc_html_e( 'Playlist Type: ', 'brightcove' ); ?></span><span
							class="data">{{ data.type }}</span></div>
				</div>
				...
				<# if (data.mediaType === 'videos') { #>
					...
					<# }#>
						...
						<# if( data.mediaType === 'playlists' ) { #>
							<input type="checkbox" name="brightcove-empty-playlists" id="brightcove-empty-playlists"
							       class="brightcove-empty-playlists attachment-filters">
							<label for="brightcove-empty-playlists">Hide Empty Playlists</label>
							<# } #>

								<a href="#"
								   class="button media-button button-primary button-large  delete-selected-button hidden"
								   disabled="disabled">Delete Selected</a>
			</div>
			<# if (data.mediaType === 'videos') { #>
				<div class="media-toolbar-primary search-form">
					<span class="spinner hidden"></span>
