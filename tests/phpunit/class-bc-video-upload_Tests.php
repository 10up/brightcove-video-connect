...
class BC_Video_Upload_Tests extends TestCase {

	protected $testFiles = [
		'classes/class-bc-video-upload.php',
		'classes/api/class-bc-cms-api.php'
	];

	protected $cms_api;

	public function mock_bc_video_upload() {

		$BC_CMS_API = $this->getMockBuilder( 'BC_CMS_API' )
		                   ->setMethods( null )
		                   ->getMock();

		$BC_Video_Upload = $this->getMockBuilder( 'BC_Video_Upload' )
		                        ->setConstructorArgs( array( $BC_CMS_API ) )
		                        ->setMethods( null )
		                        ->getMock();

		return $BC_Video_Upload;
	...
	public function test__construct() {
		...
		$BC_Video_Upload = $this->mock_bc_video_upload();

		$this->assertAttributeEquals(
			$BC_CMS_API,  /* expected value */
			'cms_api',  /* attribute name */
